...
For clients who wish to stay anonymous while doing open work, please visit the [role](discord-server.md#role) section of this document.
...
Each channel is a patron or project file.

The first channel is the house as its own patron file.
...
Each channel is accompanied by a Discord role.&#x20;

These Discord roles are used to directly associate Discord profiles with patrons and contributors.&#x20;
